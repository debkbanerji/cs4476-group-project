...
def resizeShirt():
    ...
    body_highestPoint = (body_torsoPoints[0,1] if body_torsoPoints[0,1] < body_torsoPoints[1,1] else body_torsoPoints[1,1])
    body_lowestPoint = (body_torsoPoints[4,1] if body_torsoPoints[4,1] > body_torsoPoints[5,1] else body_torsoPoints[5,1])
